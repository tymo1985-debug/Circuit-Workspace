...
(function (global) {
  ...
  var KEYS = [
    ...
    'doc.filter_all',
    'doc.filter_custom',
    'doc.new_type_template',
    'doc.new_type_prompt',
    'doc.new_type_exists',
    'doc.name.congress_type_template',
    'doc.badge_system',
    'doc.badge_custom',
    'doc.kind_letter',
    'doc.kind.letter',
    ...
    'doc.tab_archive',
    'doc.archive_hint',
    'doc.archive_search_label',
    'doc.archive_loading',
    'doc.archive_empty',
    'doc.archive_nothing_found',
    'doc.archive_entity_gone',
    'doc.archive_docs_count',
    'doc.reason_print',
    'doc.reason_send',
    'doc.reason_manual',
    'doc.times',
