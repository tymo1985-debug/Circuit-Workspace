// Документы — service worker модуля.
//
...
//
// Модуль не хранит собственных данных — он работает с общим хранилищем
...
const APP_VERSION = (self.CW_MODULES && self.CW_MODULES['documents']
