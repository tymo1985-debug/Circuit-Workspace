...
(function (global) {
  ...
  global.CWI18n.register({
    ...
    ru: {
      ...
      'hub.order_edit': 'Настроить порядок',
      'hub.order_done': 'Готово',
      'hub.order_reset': 'Восстановить стандартный порядок',
      'hub.order_hint': 'Перетаскивайте плитки за ручку или двигайте стрелками. Порядок меняется только внутри своего раздела.',
      'hub.order_prev': 'Переместить раньше',
      'hub.order_next': 'Переместить позже',
      'hub.order_drag': 'Перетащить',
      ...
      'backup.damaged': 'Файл копии повреждён или неполон: защищённые данные Журнала в нём не проходят проверку. Данные не изменены.',
    ...
    uk: {
      ...
      'hub.tier_system': 'Система',
      'hub.order_edit': 'Налаштувати порядок',
      'hub.order_done': 'Готово',
      'hub.order_reset': 'Відновити стандартний порядок',
      'hub.order_hint': 'Перетягуйте плитки за ручку або рухайте стрілками. Порядок змінюється лише всередині свого розділу.',
      'hub.order_prev': 'Перемістити раніше',
      'hub.order_next': 'Перемістити пізніше',
      'hub.order_drag': 'Перетягнути',
      ...
      'backup.damaged': 'Файл копії пошкоджений або неповний: захищені дані Журналу в ньому не проходять перевірку. Дані не змінено.',
    ...
    en: {
      ...
      'hub.order_edit': 'Arrange tiles',
      'hub.order_done': 'Done',
      'hub.order_reset': 'Restore default order',
      'hub.order_hint': 'Drag tiles by the handle or move them with the arrows. Order changes only within its own section.',
      'hub.order_prev': 'Move earlier',
      'hub.order_next': 'Move later',
      'hub.order_drag': 'Drag',
      ...
      'backup.damaged': 'The backup file is damaged or incomplete: its protected Journal data fails validation. Your data is unchanged.',
    ...
    pl: {
      ...
      'hub.tier_system': 'System',
      'hub.order_edit': 'Ustaw kolejność',
      'hub.order_done': 'Gotowe',
      'hub.order_reset': 'Przywróć domyślną kolejność',
      'hub.order_hint': 'Przeciągaj kafelki za uchwyt lub przesuwaj strzałkami. Kolejność zmienia się tylko w obrębie własnej sekcji.',
      'hub.order_prev': 'Przesuń wcześniej',
      'hub.order_next': 'Przesuń później',
      'hub.order_drag': 'Przeciągnij',
      ...
      'backup.damaged': 'Plik kopii jest uszkodzony lub niepełny: chronione dane Dziennika nie przechodzą weryfikacji. Dane pozostały bez zmian.',
    ...
    de: {
      ...
      'hub.tier_system': 'System',
      'hub.order_edit': 'Reihenfolge anpassen',
      'hub.order_done': 'Fertig',
      'hub.order_reset': 'Standardreihenfolge wiederherstellen',
      'hub.order_hint': 'Kacheln am Griff ziehen oder mit den Pfeilen verschieben. Die Reihenfolge ändert sich nur innerhalb des eigenen Bereichs.',
      'hub.order_prev': 'Nach vorne verschieben',
      'hub.order_next': 'Nach hinten verschieben',
      'hub.order_drag': 'Ziehen',
      ...
      'backup.damaged': 'Die Sicherungsdatei ist beschädigt oder unvollständig: Die geschützten Journal-Daten bestehen die Prüfung nicht. Deine Daten wurden nicht verändert.',
