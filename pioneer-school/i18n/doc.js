...
(function (global) {
  ...
  global.CWI18n.register({ uk: {
    ...
    'doc.ps.reg.opt.format.print': 'Друкований',
    ...
    'doc.ps.rec.filled_at': 'Дата заповнення',
    'doc.ps.rec.attending': 'Зможу бути присутнім на Школі',
    'doc.ps.rec.reason': 'Причина',
    'doc.ps.rec.transport': 'Можу приїхати на своєму транспорті',
    'doc.ps.rec.lodging': 'Потрібне ночівля',
    'doc.ps.rec.notes': 'Додаткові відомості',
    'doc.ps.rec.deadline': 'Термін здачі формуляра',
    ...
    'doc.ps.page.download_pdf': 'Завантажити формуляр (PDF)',
    'doc.ps.page.download_pdf_short': 'Завантажити PDF',
  ...
  global.CWI18n.register({ en: {
    ...
    'doc.ps.reg.opt.format.print': 'Printed',
    ...
    'doc.ps.rec.filled_at': 'Date filled',
    'doc.ps.rec.attending': 'I can attend the School',
    'doc.ps.rec.reason': 'Reason',
    'doc.ps.rec.transport': 'I can come using my own transport',
    'doc.ps.rec.lodging': 'Need lodging',
    'doc.ps.rec.notes': 'Additional information',
    'doc.ps.rec.deadline': 'Form submission deadline',
    ...
    'doc.ps.page.download_pdf': 'Download form (PDF)',
    'doc.ps.page.download_pdf_short': 'Download PDF',
  ...
  global.CWI18n.register({ pl: {
    ...
    'doc.ps.reg.opt.format.print': 'Drukowany',
    ...
    'doc.ps.rec.filled_at': 'Data wypełnienia',
    'doc.ps.rec.attending': 'Będę mógł/mogła uczestniczyć w Szkole',
    'doc.ps.rec.reason': 'Powód',
    'doc.ps.rec.transport': 'Mogę przyjechać własnym transportem',
    'doc.ps.rec.lodging': 'Potrzebny nocleg',
    'doc.ps.rec.notes': 'Dodatkowe informacje',
    'doc.ps.rec.deadline': 'Termin oddania formularza',
    ...
    'doc.ps.page.download_pdf': 'Pobierz formularz (PDF)',
    'doc.ps.page.download_pdf_short': 'Pobierz PDF',
  ...
  global.CWI18n.register({ de: {
    ...
    'doc.ps.reg.opt.format.print': 'Gedruckt',
    ...
    'doc.ps.rec.filled_at': 'Ausfülldatum',
    'doc.ps.rec.attending': 'Ich kann an der Schule teilnehmen',
    'doc.ps.rec.reason': 'Grund',
    'doc.ps.rec.transport': 'Ich kann mit meinem eigenen Transport kommen',
    'doc.ps.rec.lodging': 'Übernachtung benötigt',
    'doc.ps.rec.notes': 'Weitere Informationen',
    'doc.ps.rec.deadline': 'Abgabefrist des Formulars',
    ...
    'doc.ps.page.download_pdf': 'Formular herunterladen (PDF)',
    'doc.ps.page.download_pdf_short': 'PDF herunterladen',
