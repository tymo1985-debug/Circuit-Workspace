...
(function (global) {
  ...
  global.CWI18n.register({
    ...
    ru: {
      ...
      /* --- Подпись -------------------------------------------------------
         ВНИМАНИЕ: ключи ap.sign.* пока есть только в русском словаре. Для
         uk/en/pl/de текст пишет носитель языка — до тех пор CWI18n отдаёт
         русский запасной вариант (FALLBACK = 'ru'), интерфейс не ломается.
         Задача заведена в TODO.md. */
