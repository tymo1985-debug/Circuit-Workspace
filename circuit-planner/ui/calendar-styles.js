...
// App.ui.bind() app.js применяет все зарегистрированные части. Порядок
// подключения <script> в index.html поэтому безразличен — единственное
// требование: этот файл подключается РАНЬШЕ app.js.
//
